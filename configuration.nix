...

{
  ...
  #  vim # Do not forget to add an editor to edit configuration.nix! The Nano editor is also installed by default.
    ...
    git #github stuff
    nmap #network mapper for scanning things/pinging
    ...
    home-manager #manage nix packages instead of the nix config file
    evtest #keytracker
    ...
    feh #image viewer
    p7zip #7zip file extension
    qflipper #flipper zero file manager/updater
  ...
  # make sure workspaces are displayed correctly
